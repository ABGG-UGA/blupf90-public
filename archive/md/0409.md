...
- Date: Nov 13, 2014
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/409](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/409)

```

Le 13/11/2014 11:11, agngenetics@... [blupf90] a Ã©critÂ :

Â In a model with animal and permanent environment modelled wit a random regression (3rd order polynomial), I get the
