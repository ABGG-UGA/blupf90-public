...
```
Gibbs programs store the last iteration solution in binary format, which has no meaning, but are useful for continuation jobs.However you can ask to save the posterior mean e.g.  OPTION solution mean
...
Le 14/11/2012 15:57, Mohamed a écrit :
 ...
 Thanks so much, Andres, I have removed the missing phenotypic traits and it worked, but the final soultions binary is a .file and there are no program want to open it, can you tell me how to open it?
