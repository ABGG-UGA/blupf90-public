## 59: Re: [blupf90] Re: inbupgf90

- Title: 59: Re: [blupf90] Re: inbupgf90
- Author: Andres Legarra
- Date: Nov 7, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/59](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/59)

```
 write, on the command line:

 inbupgf90 --pedfile mypedigreefile.txt

 or whatever your pedigree file name is

Le 07/11/2012 15:42, Mohamed a écrit :
