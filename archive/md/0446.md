...
- Date: Feb 25, 2015
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/446](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/446)

```
 The Hessian is computed at each estimate and AIREML gives an estimate of the true Hessian. I doÂ  not see conceptual
