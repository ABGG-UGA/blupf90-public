...
```
 Just put all animals together in genotypes and pedigree but do not put phenotypes of the candidates. If your candidates are progeny tested, use a reduced data set with no daughters of the selection candidates.
