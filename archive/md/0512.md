...
The position means "Pos." in postout. So, 1 and 2 mean numbers 1 and 2 (Pos.) in postout, corresponding to effect 2 and residual variances.Â 
...
Here again, the position means the number for "Pos." in postout. So, you can choose 1 or 2 for position and any numbers (10, 20, 30, ...) for # bins.
