## 47: Re: [blupf90] Re: Problems with renumf90 in Mac oX
...
```
gfortran in mac is not easy to install.  There are different versions, and not all of them work properly. Once Xcode is installed there should be no problem.
