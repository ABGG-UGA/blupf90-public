## 28: Re: [blupf90] Re: Genomic Gibbs1f90

- Title: 28: Re: [blupf90] Re: Genomic Gibbs1f90
- Author: Andres Legarra
- Date: Jan 10, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/28](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/28)

```
 I correct the mistake (see below)

 Le 11/01/2012 08:48, Andres Legarra a Ã©critÂ :Â  Raphael,
 ...
 Le 10/01/2012 19:39, Raphael Wenceslau a Ã©critÂ :Â Dear Andres,
...
Enviadas: TerÃ§a-feira, 10 de Janeiro de 2012 12:42
...
Â  Raphael,
 ...
 Le 10/01/2012 18:33, Raphael Wenceslau a Ã©critÂ :
Â Professor Ignacy,
...
result for both, because the pedigree wouldn't have any influence on the inverse weighted G matrix formed. Using theÂ
OPTION readGimA22i, do I need to necessarily provide the A matrix and theÂ Â "x.dat_XrefID"file? I'm not sure that the
...
Â The best way to do it in the current system is to use an empty pedigree file.
 Ignacy
