...
- Date: Mar 18, 2013
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/122](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/122)

```
 You need an extra effect to account for the permanent effect.
 You can either create an extra column in data file with the "repeated" effects or use the same column as "animal"
itself.
