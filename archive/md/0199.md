...
Â Thanx for the answer, Ignacio.Â So, ifÂ I have 2 effects, the solutions fileÂ  has two times more rows than the file renadd04.ped.is that correct?Â I my case, I got 1 effect, and the difference between the 2 files (number of rows)Â was 10%.Â Henrique
...
After runningÂ airemlf90,Â i noticed thatÂ the fileÂ SOLUTIONSÂ and the file RENADD04.PEDÂ Â containsÂ differentÂ numberÂ of rows.
Is thatÂ correct?Â 
