...
- Author: Daniela Lino
- Date: Jan 8, 2014
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/223](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/223)

```
Column #6: parent averageColumn #7: is a pedigree flag that indicates if the animal has both parents known, or just
sire known, or just dam known, or both unknownÂ 
Column #8: sire id
Column #9: dam id
