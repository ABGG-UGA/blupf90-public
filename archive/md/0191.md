...
```
 ...
 The windows executable interpreted the 0 as a "blank" or space I guess. Or as suggested by Ignacio you're using two different versions of renum, one with check and the other one without it

 Andres

Le 13/11/2013 13:47, henriquetorresventura@... a Ã©critÂ :

Â Thanks for the answer Andres.I do not understand why the same files worked perfectly under windows but not under Linux system.
...
Â Hi everybody,Â I ran renumf90 under windows and everything goes ok, but under Linux, with the same files, I got the following problem:Â RENUMF90 version 1.104
