...
- Author: joy king
- Date: Jan 22, 2014
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/240](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/240)
...
Whether remove those possible wrong progenies in pedigree is according to OPTION verify_parentage xÂ  (if x=3 : detect
...
animals evaluated, to exclude an SNP from the analysis. default value 10%.Â  ==> SNPs were removed if failed QC.



On Wed, Jan 22, 2014 at 6:42 AM, marzieh heidaritabar <marzieh_heidaritabar@...> wrote:
Â So, it means that the 51 wrong SNPs that was detected by program with mendelian conflicts are due to genotyping
error.
