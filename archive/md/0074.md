...
- Date: Nov 14, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/74](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/74)

```
 It happens that on your data file you have lines with missing phenotypes for all traits. These records are irrelevant
(they don't carry any information) and annoying for Gibbs samplers; the software is asking you to delete those records.

 If you check the output of renumf90, you'll see that there are tables with "counts" of missing data for all trait
combinations.
