...
```
Andres,
I forgot to ask you about what do you mean when you wrote: "let Gibbs1f90 to create GimA22i without going through preGS". How can I do that? Do you think the way I'm using the program to obtain the predictors calculated only with the influence of the G matrix is ok?
Thank you,
Raphael.
