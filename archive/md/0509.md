...
I am trying to practice using THRGIBBS1F90. I use one example from http://nce.ads.uga.edu. But I can not finish it and I really need your help.
...
0.01
OPTION cat 2
#First, I run the thrgibbs1f90.exe file. then I continue to run postgibbs1f90.exe#So, I have the result in postout file as
