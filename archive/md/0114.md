...
```
 ...
 You can use AIREMLF90 using genomic tools by adding a "snp file" (as for doing single step) and a "fake" pedigree of "unrelated" animals:
 1 0 0
 2 0 0
 ...
 n 0 0
 ...
 Note that for G to be invertible, Airemlf90 will blend it, so that the best is to follow the suggestions in page 17 of these slides:
