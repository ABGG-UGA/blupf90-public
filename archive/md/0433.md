## 433: Re: [blupf90] Re: Low correlation between G and A22 diagonal terms

- Title: 433: Re: [blupf90] Re: Low correlation between G and A22 diagonal terms
- Author: marcelofreitasbrf
- Date: Dec 19, 2014
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/433](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/433)

```
Dear Rocha,

 G and A22 matrices were both based on the same genotyped animals and G was created using BLUPF90 with default option
(Van Raden).
