...
- Title: 75: Re: inbupgf90
- Author: Mohamed
- Date: Nov 14, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/75](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/75)

```
Thanks so much, Andres, I have removed the missing phenotypic traits and it worked, but the final soultions binary is a
.file and there are no program want to open it, can you tell me how to open it?
