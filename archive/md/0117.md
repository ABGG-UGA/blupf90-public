## 117: Re: [blupf90] Re: BLUP_SNP without pedigree file

- Title: 117: Re: [blupf90] Re: BLUP_SNP without pedigree file
- Author: Andres Legarra
- Date: Mar 8, 2013
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/117](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/117)

```

Le 08/03/2013 13:40, arnedec a écrit :
...
(ai)remlf90 only calculates genetic variance sigma_g based on the genomic relationship matrix.
 ...
 Yes. Note that after solving, you can retrieve SNP effects using postgsf90 
...
based on the following formula:
 ...
 Yes
 And are SNP effects calculated in gs3 in the same way as genetic effects are calculated in GBLUP?



 In a way because they use MME and an equivalent parameterization.

 I believe in gs3 there are no routines which can calculate the variance components with REML?



 Not by REML, but you can calculate variance components in GS3	by Gibbs sampler; this is called "VCE" in the parameter
file.
