...
Thus,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â  animal_IDÂ  sire_IDÂ Â Â Â Â  #SNP_conflictsÂ  %Conflicts

Animal - SireÂ  3067766Â Â  2773496Â Â Â Â Â Â Â Â Â Â Â Â  73Â Â Â Â Â Â Â Â Â Â Â Â Â Â  0.0013

Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â  Where 0.0013=73/56,154

The QC will remove the PROGENY with %conflictÂ  > thresholdÂ  according toÂ  OPTION verify_parentage threshold; where "3: detect and eliminate progenies with conflicts (default) ". 

On Tue, Jan 21, 2014 at 11:15 AM, marzieh heidaritabar <marzieh_heidaritabar@...> wrote:
Â Dear all,

 what is the last 2 columns of the "Gen_conflicts_all" refer to ? I know the fist column is the individual-parent pair. e.g a piece of my result in the following: I do not know what do values 73 and 0.0013 refer to? 
