...
We are intending to fit a mixed model with progeny nested into population that is nested into variety (variety/population/progeny). All this factors are crossclassified. Is there a way to fit such model using remlf90? 
