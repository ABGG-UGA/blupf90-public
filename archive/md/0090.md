...
- Date: Dec 5, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/90](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/90)

```
 Renumf90 has not read well your data. Either you have a mistake in the parameter file, or you have a wrong format in
your data file.

 For instance, the number of columns varies from line to line. Ot you have tabs, or you have separated your columns
with ";"
