...
```
I want to calculate the relaibility. I got this post, I did  option sol seand got the standard error for breeding value. How could I tranform the standard error for reliablity? is it prediction error standard devaition ?thanksdaniel
```
