...
```
You can do that treating PTA as phenotypes. Also you need heritability for PTA, and if they have greatly different accuracies, weigh each PTA using WEIGHTS. 
