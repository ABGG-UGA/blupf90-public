...
- here i divided the data (renf90.dat) such that - testdata.dat (have random 20% missing genotypesÂ  coded as -999), and validationdata.dat (with all those 20% missing data from testdata.dat). 
...
I can see the values "y"Â  have that missing value -999. I have also tried with and withoutÂ  the OPTION missing -999 at the step predictf90. 
