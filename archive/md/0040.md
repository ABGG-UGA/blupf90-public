...
- Date: Oct 18, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/40](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/40)
...
minor bug that goes undetected in Windows.
 You might try including and removing effects. Perhaps there is some weird character (like "ñ") that is messing up
things, for instance.
