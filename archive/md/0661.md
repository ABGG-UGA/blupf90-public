## 661: Re: [blupf90] equivalent models?

- Title: 661: Re: [blupf90] equivalent models?
- Author: Andres Legarra
- Date: Mar 18, 2016
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/661](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/661)

```
 It's related to computation of rank and the fact that you put 0 as levels. Everything else (determinants, y'Pe) is
fine. I keep searching

 Andres

On 17/03/16 15:08, Facundo Muñoz facundo.munoz@... [blupf90] wrote:
