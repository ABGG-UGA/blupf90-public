...
- Author: Mohamed
- Date: Dec 17, 2012
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/101](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/101)

```
Thank you one more time, Marek. What I was asking if there is a way to calculate heritability of these effects by using
