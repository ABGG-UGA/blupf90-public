...
```
Karin Meyer worked with reduced dimensionality models. We don't have it implemented. Such models may converge faster but there is a question about the validity of assumptions. 
