## 851: Re: [blupf90] parameterizing a combined model

- Title: 851: Re: [blupf90] parameterizing a combined model
- Author: Ignacy Misztal
- Date: Jul 27, 2017
- Original: [https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/851](https://groups.yahoo.com/neo/groups/blupf90/conversations/messages/851)

```
Karin Meyer worked with reduced dimensionality models. We don't have it implemented. Such models may converge faster
but there is a question about the validity of assumptions. 
 Whenever AIREMLF90 has trouble converging, Gibbs2f90 may do it. 
 Ignacy

 Â 
 On 7/27/2017 10:12 AM, 'Dr. Andreas Hoppe' dr.andreashoppe@... [blupf90] wrote:
